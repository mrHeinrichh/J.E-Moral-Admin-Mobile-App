...
class _CustomerPageState extends State<CustomerPage> {
  ...
  Future<Map<String, dynamic>?> uploadDiscountedImageToServer(
      File discountedpickedFile) async {
    try {
      var request = http.MultipartRequest(
        'POST',
        Uri.parse('https://lpg-api-06n8.onrender.com/api/v1/upload/image'),
      ...
      var fileStream =
          http.ByteStream(Stream.castFrom(discountedpickedFile.openRead()));
      var length = await discountedpickedFile.length();

      String fileExtension =
          discountedpickedFile.path.split('.').last.toLowerCase();
      var contentType = MediaType('image', 'png');
  ...
  Future<void> addCustomerToAPI(Map<String, dynamic> newCustomer) async {
    ...
    //   return;
    // } else if (_discountedImage == null) {
    //   print('Please Upload your Discounted Image.');
    //   return;
    // }
    ...
    print("Request Data: $newCustomer");
                ...
                children: [
                  ...
                  DropdownButtonFormField(
                    ...
                    decoration: const InputDecoration(
                        labelText: 'Select to Verified Customer'),
                    items: const [
                  ...
                  DropdownButtonFormField(
                    value: discountedController.text.isNotEmpty
                        ...
                        : null,
                    decoration: const InputDecoration(
                        labelText: 'Select to Approved Discount'),
                    items: const [
            ...
            TextButton(
              onPressed: () {
                setState(() {
                  ...
                  isDiscountedImageUploaded = discountedImage != null;
                });
                ...
                } else if (!isDiscountedImageUploaded) {
                  // ScaffoldMessenger.of(context).showSnackBar(
                  //   const SnackBar(
                  //     content: Text('Please Upload a Discounted Image'),
                  //     backgroundColor: Colors.red,
                  //   ),
                  // );
                  showCustomOverlay(
                      context, 'Please Upload a Discounted Image');
                } else {
